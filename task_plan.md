...
| 11. 未来组件与内部原型路线 | 进行中 | Select 单选首版和视觉/交互反馈已落地；下一步推进 TagInput，并将 OptionList / Collection、RovingFocus / Composite、Overlay / Layer、FormControl context 等作为有明确跨组件收益时才沉淀的候选。 |
